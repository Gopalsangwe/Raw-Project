...
public class CustomerController {
	...
	/*
	 * @Autowired private ImageHandlingService imageService;
	 */
    ...
    public List<Vehicle> getServicesByCategoryId(@PathVariable Long categoryId) {
        return custService.getAllVehiclesByCategoryId(categoryId);
    }
